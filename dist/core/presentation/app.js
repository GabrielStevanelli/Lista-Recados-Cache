...
const routes_1 = __importDefault(require("../../features/messages/presentation/routes/routes"));
class App {
    constructor() {
        _App_express.set(this, void 0);
        __classPrivateFieldSet(this, _App_express, (0, express_1.default)(), "f");
    }
    get server() {
    ...
    middlewares() {
        ...
        __classPrivateFieldGet(this, _App_express, "f").use((0, cors_1.default)());
    }
    routes() {
        ...
        __classPrivateFieldGet(this, _App_express, "f").use(messageRoutes);
    }
    start(port) {
